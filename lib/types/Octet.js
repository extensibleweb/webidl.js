...
define(function(require) {
    ...
    /*
    4.2.5. octet
    The result of converting an IDL octet value to an ECMAScript value is a Number that represents 
    the same numeric value as the IDL octet value. The Number value will be an integer in the range 
    [0, 255].
    ...
    */
    function toOctet(octet, extendedAttr) {
        ...
        //NOTE: I've deviated from the spec here to covert x to an unsigned number.
        return Math.abs(x);
    }
