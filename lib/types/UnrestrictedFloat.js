...
define(function(require) {
    ...
    WebIDL.UnrestrictedFloat = function(value) {
        ...
        if (!(this instanceof WebIDL.UnrestrictedFloat)) {
            return toUnrestrictedFloat(value);
        }
        ...
        property.set = function(V) {
            storage[0] = toUnrestrictedFloat(V);
            return storage[0];
        };
    ...
    function toUnrestrictedFloat(V){
    	var x, y;
    ...
    WebIDL.UnrestrictedFloat.prototype = new IDLType('UnrestrictedFloat', toUnrestrictedFloat);
});