require(['types/UnrestrictedFloat'], function() {
	...
	assertion = "If x is NaN, then return the IDL unrestricted float value that represents the IEEE 754 NaN value with the bit pattern 0x7fc00000 [IEEE-754].";
	QUnit.test(assertion, function() {
	...
	assertion = "If y is 2^128, return +∞.";
	QUnit.test(assertion, function() {
